    ...
    <div class="container-fluid mt-5 "  >
            ...
            <div class="a">
             <img  src="{{asset('pic/Peach-Saturn-Low-Chill.jpg')}}" class="card-img img-fluid imga" >  
                   ...
                   <div class="card-body text-center text-dark">
                        <a href="list"> <h5 style="font-family: Open Sans, sans-serif; color:black">Lawn Designing</h5></a>
                   </div>
          ...
          <div class="card  ">
            ...
            <img  src="{{asset('pic/Peach-Saturn-Low-Chill.jpg')}}" class="card-img-top" alt="...">
                        ...
                        <div class="card-body text-center text-dark">
                       <a href="list"> <h5 style="font-family:  sans-serif">Lawn Development</h5></a>
                   </div>
          ...
          <div class="card-body text-center text-dark">
                      <a href="list">  <h5 style="font-family:  sans-serif">Consulting</h5></a>
                   </div>
           ...
           <div class="card ">
            ...
            <a href="list">  <p class="overlay "> view all</p></a>
          <div class="card-body text-center text-dark">
                       <a href="list">  <h5 style="font-family:  sans-serif">Irrigation system</h5></a>
                   </div>
 ...
 <div class="container-fluid mb-3">
    ...
    <div class="card-deck mt-5">
          ...
          <div class="card ">
           ...
           <div class="card-body text-center">
                     <a href="list"> <h5 style="font-family:  sans-serif">winter seed</h5></a>
                   </div>
