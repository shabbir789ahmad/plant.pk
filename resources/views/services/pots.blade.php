    ...
    <div class="container-fluid mt-5 "  >
            ...
            <div class="a">
             <img  src="{{asset('pic/Peach-Saturn-Low-Chill.jpg')}}" class="card-img img-fluid imga" >  
                   ...
                   <div class="card-body text-center text-dark">
                        <a href="list"> <h5 style="font-family: Open Sans, sans-serif; color:black">pots</h5></a>
                   </div>
          ...
          <div class="card  ">
            ...
            <img  src="{{asset('pic/Peach-Saturn-Low-Chill.jpg')}}" class="card-img-top" alt="...">
                        ...
                        <div class="card-body text-center text-dark">
                       <a href="list"> <h5 style="font-family:  sans-serif; color:black">pestisides</h5></a>
                   </div>
          ...
          <div class="card-body text-center text-dark">
                      <a href="list">  <h5 style="font-family:  sans-serif; color:black"> Gardening Gloves</h5></a>
                   </div>
           ...
           <div class="card ">
            ...
            <a href="list">  <p class="overlay "> view all</p></a>
          <div class="card-body text-center text-dark">
                       <a href="list">  <h5 style="font-family:  sans-serif ;color:black">Fork</h5></a>
                   </div>
 ...
 <div class="container-fluid mb-3">
    ...
    <div class="card-deck mt-5">
          <div class="card  ">
            <div class="a">
             <img  src="{{asset('pic/2-280x280.jpg')}}" class="card-img img-fluid imga" >  
                      ...
                      <div class="card-body text-center text-dark">
                      <a href="list">    <h5 style="font-family:  sans-serif; color:black">Shovel</h5></a>
                   </div>
          ...
          <div class="card  ">
            ...
            <img  src="{{asset('pic/Eucalyptus-Deglupta-Rainbow-Tree-870x870-1-280x280.jpg')}}" class="card-img-top" alt="...">
                     ...
                     <div class="card-body text-center">
                      <a href="list">    <h5 style="font-family:  sans-serif; color:black">Rake </h5></a>
                   </div>
          ...
          <div class="card ">
           ...
           <div class="card-body text-center">
                     <a href="list"> <h5 style="font-family:  sans-serif ; color:black">Saw</h5></a>
                   </div>
           ...
           <div class="card ">
            ...
            <a href="list">  <p class="overlay "> view all</p></a>
                        ...
                        <div class="card-body text-center text-dark">
                     <a href="list">     <h5 style="font-family:  sans-serif; color:black">Wheelbarrow</h5></a>
                   </div>
          </div>
        </div>
    </div>
